...
urlpatterns = [
    ...
    #url(r'^job/parameter_predict/(?P<pk>.*)/$', views.parameter_predict, name='parameter_predict'),
    #url(r'^job/overview_predict/(?P<pk>.*)/$', views.overview_predict, name='overview_predict'),
    #url(r'^run_job/(?P<pk>.*)/$', views.run_job, name='run_job'),
    ...
    url(r'^job/overview_discover/(?P<pk>.*)/', views.overview_discover, name='overview_discover'),
