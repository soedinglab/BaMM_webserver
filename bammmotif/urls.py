...
urlpatterns = [
    ...
    url(r'^seed_results/(?P<pk>.*)/$', peng_views.peng_result_detail, name='peng_result_detail'),
    ...
    url(r'^refine_results/$', peng_views.find_peng_to_bamm_results, name='find_peng_to_bamm_result'),
