...
HELP_TEXTS = defaultdict(str, {
    ...
    'motif_db_compare': (
        'Motif database used for motif-motif comparison.'
    ),
    'e_value_cutoff': (
        'The e-value limit will be used to define a threshold for motif comparisons '
    ...
    'search_term': (
        'Search database by name of the target protein. Please note that the motifs are '
        'learnt on a dataset generated by the target protein. The motif does not always '
        'represent the binding motif of the factor.'
    ),
    'Motif_Init_File_Format': (
        'Please select the file format of the motif file.'
    ),
    'Motif_InitFile': (
        'Upload a motif file. The motif has to match the selected motif file format. '
        'BaMM models have the extension *.ihcp.'
    ),
    'bgModel_File': (
        'Upload a background model file (extension *.hbp). You only have to provide '
        'this file when you are uploading a BaMM model.'
    ),
})
...
HELP_TEXTS['database'] = HELP_TEXTS['motif_db']
